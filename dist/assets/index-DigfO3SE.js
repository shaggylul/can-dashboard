...
function vn() {
  if (!Fl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Es(Xu, vn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[hu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
hs = _o;
ys = Ln;
var Pd = { usingClientEntryPoint: !1, Events: [Zt, Un, ul, ms, vs, _o] },
  ht = {
...
const Ld = () => pe.jsx(pe.Fragment, { children: "Dashboard" }),
  Td = () => {
        ...
        pe.jsxs("div", {
          ...
          children: [
            ...
            pe.jsxs("p", {
              children: [
                "Edit ",
                pe.jsx("code", { children: "src/App.tsx" }),
...
ec(document.getElementById("root")).render(
  pe.jsx(el.StrictMode, { children: pe.jsx(Td, {}) }),
);
